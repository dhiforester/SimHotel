    ...
    <div class="row">
        <div class="col-md-12">
            <?php
                ...
                echo '  <ul>';
                echo '      <li><b>Admin</b> Betugas mengelola data akses, mengelola ketersediaan kamar, validasi pembayaran dan verifikasi publikasi testimoni pelanggan.</li>';
                echo '      <li><b>Customer Service</b> Betugas mengelola data pelanggan, mengelola data reservasi, dan membalas chat pelanggan.</li>';
                echo '      <li><b>Manajer</b> Betugas memantau semua aktivitas pada sistem melalui dashboard dan laporan.</li>';
                echo '  </ul>';
