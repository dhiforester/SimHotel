            ...
            if(empty($_POST['kontak_akses'])){
                ...
                if($JumlahKarakterKontak>20||$JumlahKarakterKontak<6||!preg_match("/^[0-9]*$/", $_POST['kontak_akses'])){
                    ...
                    if(!empty($ValidasiKontakDuplikat)){
                        echo '<small class="text-danger">Kontak yang anda masukan sudah terdaftar</small>';
                    }else{
                                    ...
                                    if(!empty($_FILES['image_akses']['name'])){
                                        ...
                                        if($tipe_gambar == "image/jpeg"||tipe_gambar == "image/jpg"||$tipe_gambar == "image/gif"||$tipe_gambar == "image/png"){
                                            if($ukuran_gambar<2000000){
                                                ...
                                                $ValidasiGambar="File maksimal 20 mb";
                                            }
                                        }else{
                                            $ValidasiGambar="Tipe file hanya diperbolehkan berformat JPG, JPEG, PNG and GIF";
                                        }
                                    }else{
                                        $ValidasiGambar="Valid";
                                        $namabaru="";
